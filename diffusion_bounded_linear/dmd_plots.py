...
def main():
    ...
    err_disc_abs_smooth_t = data["err_disc_abs_smooth_t"]  # ||Yhat_disc - Y_smooth||_F
    err_cont_abs_smooth_t = data["err_cont_abs_smooth_t"]  # ||Yhat_cont - Y_smooth||_F
    err_disc_rel_smooth_t = data["err_disc_rel_smooth_t"]  # / ||Y_smooth||
    err_cont_rel_smooth_t = data["err_cont_rel_smooth_t"]
    err_disc_norm0_smooth_t = data["err_disc_norm0_smooth_t"]  # / ||Y_smooth(0)||
    err_cont_norm0_smooth_t = data["err_cont_norm0_smooth_t"]
    
    # Errors vs noisy data
    err_disc_abs_noisy_t = data["err_disc_abs_noisy_t"]  # ||Yhat_disc - Y_noisy||_F
    err_cont_abs_noisy_t = data["err_cont_abs_noisy_t"]  # ||Yhat_cont - Y_noisy||_F
    err_disc_rel_noisy_t = data["err_disc_rel_noisy_t"]  # / ||Y_noisy||
    err_cont_rel_noisy_t = data["err_cont_rel_noisy_t"]
    err_disc_norm0_noisy_t = data["err_disc_norm0_noisy_t"]  # / ||Y_noisy(0)||
    err_cont_norm0_noisy_t = data["err_cont_norm0_noisy_t"]

    # Fields for snapshot comparisons (aligned to t_dec)
    Y_noisy   = data["Y_noisy"]  # Original noisy data (decimated)
    Y_truth   = data["Y_truth"]  # Smoothed data (decimated)
